...
public class RecrusionTreeOne : MonoBehaviour {

	public RecrusionTreeOne twigReference;
	...
	void Start () {
		...
		if (iterations >= 1) {
			for (int i = 0; i < splits; i++) {
				...
				RecrusionTreeOne instance = Instantiate (twigReference, transform.position + transform.forward * twiglength, twigRotation) as RecrusionTreeOne;
